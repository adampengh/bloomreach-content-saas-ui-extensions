...
const requestAnExport = (environment, xAuthToken, sourcePath, modifiedAfter, projectId = "core", dataTypes = [ "resourcebundle", "page", "resourcebundle", "folder" ]) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${EXPORT_API_PATH$1}/`, {
        method: "POST",
        headers: {
...
const getOperationDetails = (environment, xAuthToken, operationId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${EXPORT_API_PATH$1}/operations/${operationId}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const downloadExportedFiles = (environment, xAuthToken, operationId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${EXPORT_API_PATH$1}/operations/${operationId}/files`, {
        method: "GET",
...
const getImportOperationStatus = (environment, xAuthToken, operationId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${EXPORT_API_PATH}/operations/${operationId}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getAllContentTypes = (environment, xAuthToken, projectId = "development") => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CONTENT_TYPE_API_PATH}/${projectId}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getContentType = (environment, xAuthToken, contentTypeName, projectId = "development") => __awaiter(void 0, void 0, void 0, (function*() {
    ...
    const response = yield axios(`https://${environment}.bloomreach.io/${CONTENT_TYPE_API_PATH}/${projectId}/${contentType}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const deleteContentType = (environment, xAuthToken, contentType) => __awaiter(void 0, void 0, void 0, (function*() {
    ...
    const response = yield axios(`/api/contenttypes/${contentType}?environment=${environment}`, {
        method: "DELETE",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getPage = (environment, xAuthToken, channel, path, projectId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CONTENT_API_PATH}/project/${projectId}/channel/${channel}/page/${path}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getFolder = (environment, xAuthToken, folderPath, depth = "5") => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${FOLDER_API_PATH}/${folderPath}?depth=${depth}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const createOrUpdateFolder = (environment, xAuthToken, folderType, folderPath, displayName, optAllowedDocumentTypes, optAllowedFolderTypes) => __awaiter(void 0, void 0, void 0, (function*() {
    ...
    const response = yield axios(`https://${environment}.bloomreach.io/${FOLDER_API_PATH}/${folderPath}`, {
        method: "PUT",
        headers: {
            "x-auth-token": xAuthToken,
            "Content-Type": "application/json"
...
const getAllProjects = (environment, xAuthToken) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${PROJECTS_API_PATH}/`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getDeveloperProject = (environment, xAuthToken, projectId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${PROJECTS_API_PATH}/${projectId}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const mergeProject = (environment, xAuthToken, projectId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${PROJECTS_API_PATH}/${projectId}:merge`, {
        method: "POST",
        headers: {
            "x-auth-token": xAuthToken,
            "Content-Type": "application/json"
...
const rebaseProject = (environment, xAuthToken, projectId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${PROJECTS_API_PATH}/${projectId}:rebase`, {
        method: "POST",
        headers: {
            "x-auth-token": xAuthToken,
            "Content-Type": "application/json"
...
const reopenProject = (environment, xAuthToken, projectId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${PROJECTS_API_PATH}/${projectId}:reopen`, {
        method: "POST",
        headers: {
            "x-auth-token": xAuthToken,
            "Content-Type": "application/json"
...
const deleteProject = (environment, xAuthToken, projectId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`/api/projects/${projectId}?environment=${environment}`, {
        method: "DELETE",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getAllChannels = (environment, xAuthToken) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CHANNEL_API_PATH}/channels`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getChannel = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CHANNEL_API_PATH}/channels/${channelId}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getChannelFieldGroups = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CHANNEL_API_PATH}/channels/${channelId}/fieldgroups`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const putChannelFieldGroups = (environment, xAuthToken, channelId, fieldGroup, data, optXResourceVersion) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CHANNEL_API_PATH}/channels/${channelId}/fieldgroups/${fieldGroup}`, {
        method: "PUT",
        headers: Object.assign({
            "x-auth-token": xAuthToken,
            Accept: "application/json",
...
const getChannelParameters = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CHANNEL_API_PATH}/channels/${channelId}/parameters`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getChannelParameter = (environment, xAuthToken, channelId, parameter) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${CHANNEL_API_PATH}/channels/${channelId}/parameters/${parameter}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
 ...
 */ const getAllComponentGroups = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$4}/channels/${channelId}/component_groups`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getComponentGroup = (environment, xAuthToken, channelId, componentGroup) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$4}/channels/${channelId}/component_groups/${componentGroup}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getAllComponents = (environment, xAuthToken, channelId, componentGroup) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$3}/channels/${channelId}/component_groups/${componentGroup}/components/`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getComponent = (environment, xAuthToken, channelId, componentGroup, componentName) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$3}/channels/${channelId}/component_groups/${componentGroup}/components/${componentName}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getAllLayouts = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$2}/channels/${channelId}/layouts`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getLayout = (environment, xAuthToken, channelId, layout) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$2}/channels/${channelId}/layouts/${layout}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getAllRoutes = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$1}/channels/${channelId}/routes`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getRoute = (environment, xAuthToken, channelId, route) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH$1}/channels/${channelId}/routes/${route}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getAllMenus = (environment, xAuthToken, channelId) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH}/channels/${channelId}/menus`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getMenu = (environment, xAuthToken, channelId, menu) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH}/channels/${channelId}/menus/${menu}`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getMenuItems = (environment, xAuthToken, channelId, menu) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH}/channels/${channelId}/menus/${menu}/items`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
...
const getMenuProperties = (environment, xAuthToken, channelId, menu) => __awaiter(void 0, void 0, void 0, (function*() {
    const response = yield axios(`https://${environment}.bloomreach.io/${SITE_MANAGEMENT_API_PATH}/channels/${channelId}/menus/${menu}/properties`, {
        method: "GET",
        headers: {
            "x-auth-token": xAuthToken
        }
