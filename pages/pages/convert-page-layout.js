...
function ConvertPageLayout() {
  ...
  return (
    <>
      <Head>
        <title>Convert Page Layout</title>
      </Head>
      <PageTitleWrapper>
        <PageTitle
...
ConvertPageLayout.getLayout = (page) => <SidebarLayout>{page}</SidebarLayout>;
export default ConvertPageLayout
