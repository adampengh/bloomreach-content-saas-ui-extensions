    ...
    <>
      ...
      >
        <Stack spacing={3} display={'block'}>
          <Typography variant='h4'>Pages API</Typography>
          ...
          <Typography variant='p' component='p' sx={{ mt: '0 !important' }}><strong>https://{environment}.bloomreach.io/delivery/site/v1/channels/{selectedChannel}/pages{pagePath}</strong></Typography>
